...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Edit ')." ".$sponsor->name }}</div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('sponsors.update', $sponsor->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ (old('name') !== null) ? old('name') : $sponsor->name }}" id="name" autofocus required/>
                                    @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="url" name="url" class="form-control @error('url') is-invalid @enderror" value="{{ (old('url') !== null) ? old('url') : $sponsor->url }}" id="url" required/>
                                    @error('url')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
